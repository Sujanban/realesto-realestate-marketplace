...
@section('main-container')
    ...
    <div class="terms">
        ...
        <h3>Welcome to realesto!</h3>

        <p>These terms and conditions outline the rules and regulations for the use of RealEsto's Website, located at RealEsto.
<br>
        By accessing this website we assume you accept these terms and conditions. Do not continue to use realesto if you do
...
<br>
        ...
        <h2>Cookies</h2>
        <p>We employ the use of cookies. By accessing realesto, you agreed to use cookies in agreement with the RealEsto's
        Privacy Policy.
<br>
        ...
        <h2>License</h2>
        <p>Unless otherwise stated, RealEsto and/or its licensors own the intellectual property rights for all material on
        realesto. All intellectual property rights are reserved. You may access this from realesto for your own personal use
        subjected to restrictions set in these terms and conditions.</p><br>

        <h2>You must not:</h2>

        <p>Republish material from realesto
        Sell, rent or sub-license material from realesto
        Reproduce, duplicate or copy material from realesto
        Redistribute content from realesto
        This Agreement shall begin on the date hereof. Our Terms and Conditions were created with the help of the TermsFeed
...
<br>
        ...
        of the website. RealEsto does not filter, edit, publish or review Comments prior to their presence on the website.
        Comments do not reflect the views and opinions of RealEsto,its agents and/or affiliates. Comments reflect the views
        and opinions of the person who post their views and opinions. To the extent permitted by applicable laws, RealEsto
...
<br>
        RealEsto reserves the right to monitor all Comments and to remove any Comments which can be considered
...
<p>
        ...
        activity.
        You hereby grant RealEsto a non-exclusive license to use, reproduce, edit and authorize others to use, reproduce and
...
<br>
        ...
        <h2> may consider and approve other link requests from the following types of organizations:</h2>
<p>
        ...
        with us; (c) the benefit to us from the visibility of the hyperlink compensates the absence of RealEsto; and (d) the
...
<br>
        ...
        must inform us by sending an e-mail to RealEsto. Please include your name, your organization name, contact
...
<p>
        ...
        No use of RealEsto's logo or other artwork will be allowed for linking absent a trademark license agreement.
<br>
        iFrames
