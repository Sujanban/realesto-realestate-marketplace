            ...
            <div class="footer_link">
                ...
                <div class="link_column">
                    <div>
                        ...
                        <a href="{{url('/admin/buy')}}">Buy</a>
                        <a href="{{url('/admin/sell')}}">Sell</a>
                        {{-- <a href="{{url('/rent')}}">Rent</a> --}}
                    </div>
                    <div>
                        <a href="{{url('/admin/about')}}">About Us</a>
                        <a href="{{url('/admin/contact')}}">Contact Us</a>
                        <a href="{{url('/admin/policy')}}">Privacy Policy</a>
                        <a href="{{url('/admin/terms')}}">Terms and Conditions</a>
                    </div>
                </div>
            </div>
            <div class="footer_newsletter">
                ...
                <div>
                    <input type="checkbox" name="checkbox" class="term"> I have read and agree to the <a
                        href="{{url('/admin/policy')}}">Privacy Policy</a>
                </div>
            </div>
        </div>
